...
from algos.sb3_contrib_buffers import RecurrentDictRolloutBuffer, RecurrentRolloutBuffer
...
class RecurrentPPO(OnPolicyAlgorithm):
    ...
    :param adaptive_stack: Whether or not to use the default Frame Stacking approach (sliding window for LSTM updates) or use Adaptive Stacking.
    :param learning_rate: The learning rate, it can be a function
        of the current progress remaining (from 1 to 0)
    :param n_stack: Recurrence/Sequence/Context length for the RNN (i.e. sliding window if using Frame Stacking)
    ...
    def __init__(
        ...
        self.adaptive_stack = adaptive_stack
    ...
    def _setup_model(self) -> None:
        ...
        # hidden_state_buffer_shape = (self.n_stack, lstm.num_layers, self.n_envs, lstm.hidden_size)
