...
parser.add_argument("--with_cnn", help="Use CNN.", action='store_true', default=False)
...
parser.add_argument('--maze_length', type=int, default=1, help="Corridor length for tmaze or Grid size for MiniGrid")
...
parser.add_argument("--save_video", help="", action='store_true', default=False)
parser.add_argument("--enjoy_step_by_step", help="", action='store_true', default=False)
